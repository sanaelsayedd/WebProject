...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO `purchase_transaction`(`UserID`, `BookID`, `Quantity`, `TotalPrice`) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("iiid", $UserID, $BookID, $Quantity, $TotalPrice);
    ...
    <div class="form-container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" id="TotalPrice" name="TotalPrice" step="0.01" min="0.01" required>
            </div>
